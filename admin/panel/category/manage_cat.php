...
$data = $util->displayCatData();

if (isset($_GET["status"])) {
    $id = $_GET["id"];

    if ($_GET["status"] === "delete") {
        $result = $util->deleteCat($id);
...
<main>
    ...
    if ($showUpdateAlert) {
        ...
        header("refresh:1;url=manage_cat.php");
    } else if (isset($errorMessage)) {
        echo ' <div class="alert alert-danger" role="alert">
        <strong>Error!</strong> ' . $errorMessage . '
    </div>';
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center"><img src="uploads/<?php echo $row['catImg']; ?>" style="width: 150px;" height="100%" alt=""></td>
